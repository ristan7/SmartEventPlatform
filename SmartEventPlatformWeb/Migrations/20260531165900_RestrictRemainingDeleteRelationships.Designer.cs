...
namespace SmartEventPlatformWeb.Migrations
{
    ...
    [Migration("20260531165900_RestrictRemainingDeleteRelationships")]
    partial class RestrictRemainingDeleteRelationships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartEventPlatformWeb.Domains.EventType", b =>
                {
                    b.Property<long>("EventTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SmartEventPlatformWeb.Domains.Participant", b =>
                {
            ...
            modelBuilder.Entity("SmartEventPlatformWeb.Domains.Registration", b =>
                {
            ...
            modelBuilder.Entity("SmartEventPlatformWeb.Domains.Event", b =>
                {
                    b.HasOne("SmartEventPlatformWeb.Domains.EventType", "EventType")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("SmartEventPlatformWeb.Domains.Registration", b =>
                {
                    ...
                    b.HasOne("SmartEventPlatformWeb.Domains.Participant", "Participant")
                        .WithMany("Registrations")
